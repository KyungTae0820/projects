...
{
	// circular list is not copyable to pass it by pointer
...
{
	// first create a vector to hold our data
	std::vector<std::string> contents{"768", "1024", "1536"};

	// then create a new list with that data
	ULListStr * populatedList = makeList(contents);

	// then assert that the list contains that data
