...
{
  //Create new Book
  Product* newBook = new Book(categoryID(), prodName_, price_, 
                              qty_, isbn_, author_);
  return newBook;
}
...
{
  //Create new Clothing
  Product* newClothing = new Clothing(categoryID(), prodName_, price_, 
                                qty_, size_, brand_);
  return newClothing;
}
...
{
  //Create new Movie
  Product* newMovie = new Movie(categoryID(), prodName_, price_, 
                                qty_, genre_, rating_);
  return newMovie;
}
